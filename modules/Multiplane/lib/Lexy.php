<?php
/**
 * Modified variant, that allows pretty printing the generated html
 */
...
class Lexy {
     ...
     * @return string
     */
    protected function compile_prettify($value) {

        // remove white space before  most php tags to avoid wrong indentation
        return preg_replace('/([\r\n])(\s*)\<\?php(?!\s*(echo|\$app->trigger))/', '$1<?php', $value);
